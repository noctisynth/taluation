<template>
    <div class="courses-container">
        ...
        <div class="page-header">
            <h2 class="courses-title">课程列表</h2>
                ...
                <template #content>
                    <div class="course-info">
                        ...
                        <div class="view-details">
                            <Button label="查看详细" icon="pi pi-external-link" class="p-button-text" @click.stop="openCourseDetails(course)" />
                        </div>
                    </div>
                </template>
            </Card>
                ...
                <TabView>
                    ...
                    <TabPanel header="评价列表" value="evaluations">
                        <div class="evaluations-list">
                            <div class="add-evaluation-container" v-if="isStudent">
                                <Button label="添加评价" icon="pi pi-plus" @click="showAddEvaluationForm = true" />
                                ...
                                <Dialog v-model:visible="showAddEvaluationForm" modal header="添加评价" :style="{width: '500px'}" class="add-evaluation-dialog">
                                    <div class="add-evaluation-form">
                                        ...
                                        <div class="form-field">
                                            <label>评价内容</label>
                                            <Textarea v-model="newEvaluation.comment" rows="5" placeholder="请输入您对该课程的评价..." class="w-full" />
                                        </div>
                                    </div>
                                    <template #footer>
                                        <Button label="取消" icon="pi pi-times" @click="showAddEvaluationForm = false" class="p-button-text" />
                                        <Button label="提交" icon="pi pi-check" @click="submitEvaluation" :loading="submitting" />
                                    </template>
                                </Dialog>
                            </div>
                            ...
                            <div v-else class="empty-evaluations">
                                ...
                                <p>暂无评价</p>
                                <small v-if="isStudent">成为第一个评价这门课程的人吧！</small>
                                <div class="empty-action" v-if="isStudent">
                                    <Button label="添加评价" icon="pi pi-plus" @click="showAddEvaluationForm = true" />
                                </div>
                            </div>
                        </div>
